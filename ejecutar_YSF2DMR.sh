...
xterm -geometry 86x7+1277+803 -bg grey -fg black -fa 'roboto' -fs 9x -T YSF2DMR -e ./YSF2DMR YSF2DMR.ini & 

cd /home/orangepi/MMDVMHost
xterm -geometry 86x7+1277+1014 -bg grey -fg black -fa 'roboto' -fs 9x -T MMDVMFUSION -e ./MMDVMFUSION MMDVMFUSION.ini
